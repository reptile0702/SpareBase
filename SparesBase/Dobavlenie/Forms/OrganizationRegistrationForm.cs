...
{
    public partial class OrganizationRegistrationForm : Form
    {
        public OrganizationRegistrationForm()
        {
            InitializeComponent();
        }
        ...
        private void ToRegister()
        {
            ...
            DatabaseWorker.SqlQuery("INSERT INTO Organizations VALUES('','" + tbOrganizationName.Text + "', '" + tbSite.Text + "', '" + tbPhone.Text + "', 0)");
